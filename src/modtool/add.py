...
argparser.add_argument('-t', '--block-type', type=str,
                       help=f"One of {', '.join(ModToolAdd.block_types)}.")
argparser.add_argument('--license-file', type=str, default=None,
                       help="File containing the license header for every source code file.")
argparser.add_argument('--copyright', type=str, default=None,
                       help="Name of the copyright holder (you or your company) MUST be a quoted string.")
argparser.add_argument('--argument-list', type=str, default=None,
                       help="The argument list for the constructor and make functions.")
argparser.add_argument('--add-python-qa', action='store_true',
                       help="If given, Python QA code is automatically added if possible.")
argparser.add_argument('--add-cpp-qa', action='store_true',
                       help="If given, C++ QA code is automatically added if possible.")
argparser.add_argument('--skip-cmakefiles', action='store_true',
...
try:
    tool = ModToolAdd(args.blockname,
