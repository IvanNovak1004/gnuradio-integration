...
argparser.add_argument('--addl_includes', type=str, default=None,
                       help='Comma separated list of additional include directories (default None)')
argparser.add_argument('-D', '--define_symbols', type=str, action='extend', nargs='*',
                       help='Set precompiler defines')
argparser.add_argument('-u', '--update-hash-only', action='store_true')
args = argparser.parse_args()

try:
    tool = ModToolGenBindings(args.blockname,
